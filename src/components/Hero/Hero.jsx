        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold text-navy leading-[1.1] mb-6">
              Stories Today,<br />
              <span className="text-primary-light italic">Smiles Tomorrow</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              ...
              <button className="px-8 py-4 bg-white text-navy border-2 border-gray-100 rounded-full font-bold text-lg hover:bg-gray-50 transition-all flex items-center gap-3 soft-shadow">
                Watch Video
                <div className="w-8 h-8 rounded-full gradient-teal flex items-center justify-center text-white">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -top-10 -left-10 w-24 h-24 text-primary-light/20"
            >
            ...
            <motion.div 
              ...
              className="absolute -bottom-10 -right-10 w-20 h-20 text-pastel-pink"
            >
              <svg viewBox="0 0 100 100" fill="currentColor">
